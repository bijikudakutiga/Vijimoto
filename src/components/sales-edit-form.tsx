    ...
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-5 items-start">
      <div className="card">
        ...
        <div className="space-y-2">
          {items.map((it) => (
            <div key={it.key} className="border border-line rounded-2xl p-3 grid grid-cols-2 sm:grid-cols-[1.6fr_0.8fr_0.6fr_1fr_1fr_auto] gap-2 items-end">
              <div>
              ...
              <div>
                ...
                <input
                  type="number" onFocus={(e) => e.target.select()} min={0} value={it.qty}
              ...
              <div>
                ...
                <input
                  type="number" onFocus={(e) => e.target.select()} min={0} value={it.unit_price} disabled={!it.is_manual_price}
              ...
              <div>
                ...
                <input
                  type="number" onFocus={(e) => e.target.select()} min={0} value={it.discount_amount}
      ...
      <div className="card lg:sticky lg:top-6">
        ...
        <div className="space-y-3 mb-4">
          <div>
            ...
            <input
              type="number" onFocus={(e) => e.target.select()} min={0} value={paymentTermDays}
          ...
          <div>
            ...
            <input
              type="number" onFocus={(e) => e.target.select()} min={0} value={overallDiscount}
          ...
          <div className="flex items-center justify-between border border-line rounded-xl px-3 py-2.5">
            ...
            <input
              type="number" onFocus={(e) => e.target.select()} min={0} max={100} disabled={!taxEnabled} value={taxPercent}
